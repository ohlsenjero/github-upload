...
// alert('LL '+setsHover.length);
                ...
                tn.src = 'images/thumb_' + thes.setimgs[index][2];
                    ...
                    function loadInsideGallery(name, el, index){
                        ...
                        if(fotos[key][index][1]==whatGal){
                            $(el).append('<li><img class="' + fotos[key][index][1] + ' '+fotos[key][index][2]+' '+ fotos[key][index][0]+'" src="images/thumb_' + fotos[key][index][2] + '" /></li>');
        ...
        $('.forced-linko').click(function(){
                var clickIndex;
                        ...
                        $('#sets li:nth-child('+(4)+')').find('a')[0].click();
