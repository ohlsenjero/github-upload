...
var keys=[];
        ...
        thes.load_sets = function(el) { // function - load sets of images
            ...
            // });
            ////
            // this is being done beforehand,  so as to loadthem with dropdown menu (according to the info in each one of them)
          ...
          //  }
            ...
            $(sets).click(function() { 
                ...
                if(images[set][0]!="vid"){
                    ...
                    if(images[set][0][images[set][0].length-1]!="photos"){ 
...
///desision:
   ...
   /////////////////////////////////////////////////////////////////  all available==== array with diff names ([2]or sm)
                        ...
                        thes.load_thumbs($(thes).find('#thumbs')[0], 0, 'gallery');
...
// alert('LL '+setsHover.length);
            ...
            if(images[set][0]!="vid"){   ///////////// if(set!="set uno"){ images[set][0][images[set][0].length-1]
                ...
                if(loadType=='gallery'){
                   ...
                   //alert(images[set][0][0]);
                    ...
                    $(el).append('<li><img class="' + thes.setimgs[index][1] + ' '+thes.setimgs[index][2]+ '" src="images/thumb_' + thes.setimgs[index][2] + '" /></li>');
                    ...
                    $(a).click(function() { // binding onclick to thumbs
                       ...
                       /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        /////////
                        ///                         SO HERE'S THE FIX
                        ///      rather than doing it ALL again, redo the whole functionality for the MULTI GALLERY (gallery, thumbnail, everything)
                        //                       just do THAT PART from scratch, load the images in, done, and independent from the rest
                        ///
                        //                  otherwise it gets all messed up

                        ///             algo asi como los artistas que si funciona y simple.... aca abajo, esta function 
                        ///(loadInsideGalleryTransition(name, el, 0);) 
                        ////es la que tiene que llevar   la funcionalidad, en vez de tirarte denuevo a toda esta mierda...............

                     /*  ........ $.each(fotos, function(key, value) { 
                            
                        if(fotos[key][index][1]==whatGal){
 
                         $(el).append('<li><img class="' + fotos[key][index][1] + ' '+fotos[key][index][2]+ '" src="images/thumb_' + fotos[key][index][2] + '" /></li>');................... etc  */
                ...
                tn.src = 'images/thumb_' + thes.setimgs[index][2];
                        ...
                        $(el).append('<li><img class="' + thes.setimgs[1][index][0] + ' '+thes.setimgs[1][index][1]+ '" src="images/thumb_' + thes.setimgs[1][index][1] + '" /></li>');
                        ...
                        tn.src = 'images/thumb_' + thes.setimgs[1][index][1];
                    ...
                    function loadInsideGallery(name, el, index){
                        ...
                        // //alert('rrt'+fotos[key][index][1]);

                            
                        // if(fotos[key][index][1]==whatGal){

                        //         //alert($($(thes).find('#thumbs li .'+whatGal)[0]));

                           
                            
                        //     $(el).append('<li><img class="' + fotos[key][index][1] + ' '+fotos[key][index][2]+ '" src="images/thumb_' + fotos[key][index][2] + '" /></li>');
                        //     //alert(whatGal);
                        //  }else{
                        ...
                        //             return;
                        //             ////this return, or it loads more or it doesnt without it
                        ...
                        //         }
                        //             //////  close, but still not ... just START OVER  thinking like data-base from the beggining...
                        //             ////                                                                        you'll learn one thing or two
                            ...
                            $('#thumbs li').click(function(){
                             ...
                             if ((index + 1) < fotos[key].length) {
                                   ...
                                   $("#thumbs li").find('.'+whatGal).click();
                                      ...
                                      /////// JUST NEED TO FORCE CLICK THAT FIRST THUMBNAIL!!!!!! !!
            ...
            //// set vids - thumbs-vid
                ...
                tn.src = 'images/thumb_' + thes.setimgs[1][index][2];
