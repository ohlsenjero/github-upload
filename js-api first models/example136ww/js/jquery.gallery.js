...
$.fn.gallery = function() {
    ...
    var rememberWich; /// which class of li a clicked (dropdown)
...
// alert('LL '+setsHover.length);
                ...
                if(loadType=='gallery'){
                   ...
                   // alert(thes.setimgs[0][0][0]);
                    if(images[set][0][0][0]=="multi"){
                        ...
                        $(el).append('<li><img class="' + thes.setimgs[0][index][0] + ' '+thes.setimgs[0][index][2]+ '" src="images/thumb_' + thes.setimgs[0][index][2] + '" /></li>');
 ...
 var tn = new Image();
                ...
                tn.src = 'images/thumb_' + thes.setimgs[1][index][2];
                          ...
                          ///INSIDE FUNCTION, CALLED WHEN CLICK IN THUMB >> according to name



                        // $(el).append('<li><img class="' + thes.setimgs[1][index][0] + ' '+thes.setimgs[1][index][2]+ '" src="images/thumb_' + thes.setimgs[1][index][2] + '" /></li>');
                    ...
                    function loadInsideGallery(name, el, index){
                        ...
                        $(tn).load(function() {
                            ...
                            if ((index + 1) < thes.setimgs[1][1].length) {
                                ...
                                $(thes).find('#loading').html('Finished loading <strong>' + thes.setimgs[1][1].length + '</strong> images');
