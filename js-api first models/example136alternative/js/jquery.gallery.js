            ...
            if(images[set][0]!="vid"){   ///////////// if(set!="set uno"){ images[set][0][images[set][0].length-1]
                ...
                if(loadType=='gallery'){
                   ...
                   // alert(thes.setimgs[0][0][0]);
                    ...
                    $(el).append('<li><img class="' + thes.setimgs[0][index][1] + ' '+thes.setimgs[0][index][2]+ '" src="images/thumb_' + thes.setimgs[0][index][2] + '" /></li>');
                ...
                tn.src = 'images/thumb_' + thes.setimgs[1][index][2];
                    ...
                    function loadInsideGallery(name, el, index){
                        ...
                        //alert( thes.setimgs[1][index][1]);

                       if( thes.setimgs[1][index][1]==whatGal){
                            //alert('whatGal');
                        

                        $(el).append('<li><img class="' + thes.setimgs[1][index][1] + ' '+thes.setimgs[1][index][2]+ '" src="images/thumb_' + thes.setimgs[1][index][2] + '" /></li>');

                        }else{

                            //alert('whatGal');

                            ///// por alguna razon sigue cargando las que no deberian ir
                             ...
                             if ((index + 1) < thes.setimgs[1].length) {
                               ...
                               // return;
                                ...
                                //algo mejora con este ///// hay un par de mas


                                ///// so here is the BUG, dilemma >>>>  (with return)  it loads the right thumbnails which wont work, 
                                ////////                               or else it loads the thumbnails * thumbnailAmount, but then they work
                                ...
                                $($(thes).find('#thumbs li img')[0]).click(); ////opens first
                        ...
                        $(tn).load(function() {
                            ...
                            allPics.push([thes.setimgs[1][index][0],thes.setimgs[1][index][2]]);   /////////////   push ALSO THE NAME, to compare!!!  (and get rid of newI....)
